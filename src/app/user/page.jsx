...
import { Search, User, School, GraduationCap, BookOpen, Users, BrainCircuit, Sun, Moon, Languages } from 'lucide-react';
...
const UserDashboard = () => {
  ...
  const translations = {
    en: {
      ...
      ai_career_text: "Discover your ideal career path using our AI-powered assessment"
    },
    rw: {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">{t.featured_colleges}</h2>
            </div>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-medium text-gray-900 dark:text-white">Carnegie Mellon University Africa</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Kigali, Rwanda</p>
                  <p className="text-xs text-indigo-600 dark:text-indigo-400 mt-1">Ranked #1 in Rwanda</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-20 h-20 bg-indigo-100 dark:bg-slate-700 rounded flex items-center justify-center">
                ...
                <div>
                  <h3 className="font-medium text-gray-900 dark:text-white">University of Kigali</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Kigali, Rwanda</p>
                  <p className="text-xs text-indigo-600 dark:text-indigo-400 mt-1">Ranked #3 in Rwanda</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">{t.available_scholarships}</h2>
            </div>
            <div className="space-y-3">
              <div className="p-4 bg-indigo-50 dark:bg-slate-700 rounded-lg border border-indigo-100 dark:border-slate-600">
                <h3 className="font-medium text-gray-900 dark:text-white">{t.govt_scholarship}</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">{t.up_to} RWF 2,500,000</p>
              </div>
              <div className="p-4 bg-indigo-50 dark:bg-slate-700 rounded-lg border border-indigo-100 dark:border-slate-600">
                <h3 className="font-medium text-gray-900 dark:text-white">STEM Excellence Scholarship</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">{t.up_to} RWF 1,500,000</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">{t.career_assessment}</h2>
            </div>
            <div className="text-center py-6">
              <p className="text-gray-600 dark:text-gray-400 mb-4">{t.ai_career_text}</p>
